...
const Footer = () => {
  return (
    <footer className='min-h-[70px] p-10 text-center relative'>
      <ul className='flex md:hidden items-center justify-center space-y-1'>
      ...
      <p className='tracking-[1px] text-base font-light'>
        Designed by{' '}
        <a href='https://github.com/bchiang7' className='text-green'>
          Brittany
        </a>{' '}
        & Developed by{' '}
        <a href='https://github.com/MuttakinHasib' className='text-green'>
          Hasib
        </a>
      </p>
    </footer>
